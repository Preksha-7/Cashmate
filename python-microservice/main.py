...
import pytesseract
# ADD THIS LINE: Explicitly set the path to tesseract.exe
pytesseract.pytesseract.tesseract_cmd = r'C:\Program Files\Tesseract-OCR\tesseract.exe' # <--- MAKE SURE THIS PATH IS CORRECT FOR YOUR SYSTEM
...
class PDFParser:
    ...
    def parse_pdf(self, pdf_file: BytesIO) -> ParsedData:
        try:
            ...
            pdf_file.seek(0)
            all_raw_tables = self.extract_tables_pdfplumber(pdf_file)
